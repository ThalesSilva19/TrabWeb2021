...
export const ArtLocalStorage = () => {
	const [value, setValue] = useState(
		...
		[
			...
			{id: 2, name: "Objeto azul", description: "The best digital art", image:"https://image.shutterstock.com/image-photo/thread-ball-isolated-on-white-260nw-69076774.jpg", belong: "theCollector", creator:"breno", quantity: 1, quantitySold:0, price:25.00, creation:"2021-06-27T22:53:45.615Z"},
			{id: 3, name: "Objeto azul", description: "The best digital art", image:"https://image.shutterstock.com/image-photo/thread-ball-isolated-on-white-260nw-69076774.jpg", belong: "theCollector", creator:"breno", quantity: 1, quantitySold:0, price:25.00, creation:"2021-06-27T22:53:45.615Z"},
			{id: 4, name: "Objeto azul", description: "The best digital art", image:"https://image.shutterstock.com/image-photo/thread-ball-isolated-on-white-260nw-69076774.jpg", belong: "theCollector", creator:"breno", quantity: 1, quantitySold:0, price:25.00, creation:"2021-06-27T22:53:45.615Z"},
